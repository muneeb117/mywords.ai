...
class StepIndicatorHumanizer extends StatelessWidget {
  StepIndicatorHumanizer({super.key, required this.activeSteps});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Spacer(),
          StepIndicatorRoundedComponent(isActive: activeSteps.contains(1), stepNumber: '1', stepTitle: 'Prompt'),
          SizedBox(width: 6),
